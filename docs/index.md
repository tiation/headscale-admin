---
layout: default
title: Headscale Admin - Enterprise Solution
...
<div class="tiation-hero">
  ...
  <div class="hero-content">
    ...
    <h1 class="hero-title">
      ...
      <span class="gradient-text">Headscale Admin</span>
    </h1>
    ...
    <div class="hero-cta">
      ...
      <a href="https://github.com/tiation/headscale-admin" class="btn-tertiary">📁 View Code</a>
    </div>
  </div>
</div>
...
# Run container
docker run -p 8080:8080 headscale-admin
```
...
### 📞 Getting Help
- **📚 Documentation**: [Full documentation](https://tiation.github.io/headscale-admin)
- **❓ FAQ**: [Frequently asked questions](faq.md)
- **🐛 Issues**: [GitHub Issues](https://github.com/tiation/headscale-admin/issues)
- **💬 Discussions**: [GitHub Discussions](https://github.com/tiation/headscale-admin/discussions)
